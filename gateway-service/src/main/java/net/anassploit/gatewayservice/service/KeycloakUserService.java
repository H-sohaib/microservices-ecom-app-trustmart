        ...
        return getAdminToken()
                .flatMap(token -> getUserById(userId)
                        .flatMap(existingUser -> {
                            ...
                            updatePayload.put("firstName", request.getFirstName() != null ? request.getFirstName() : existingUser.getFirstName());
                            updatePayload.put("lastName", request.getLastName() != null ? request.getLastName() : existingUser.getLastName());
